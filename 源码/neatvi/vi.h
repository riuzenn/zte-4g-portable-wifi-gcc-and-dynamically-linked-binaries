...
int sbuf_str(struct sbuf *sbuf, const char *s);
int sbuf_mem(struct sbuf *sbuf, const void *s, long len);
...
int conf_highlight(int idx, const char **ft, const int **att, const char **pat, int *end);
